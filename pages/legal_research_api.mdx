...
To connect to the EventStream, you need to send a `POST` request to the endpoint and listen to the events of the `EventSource`, the last event is be the *confidence* message.
