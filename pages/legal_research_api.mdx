...
The endpoint url is: `https://api.ailegis.pro/app/advice/combined`
...
The country field will for the search to be done in a specific jurisdiction. ( Currently only CH is supported, DE,FR,US and BR are in beta state )
...
const endpoint_url = "https://api.ailegis.pro/app/advice/combined";
