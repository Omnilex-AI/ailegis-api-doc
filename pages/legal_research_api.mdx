...
The endpoint url is: `https://api.omnilex.ai/app/advice/combined`
...
const endpoint_url = "https://api.omnilex.ai/app/advice/combined";
...
```json
{
  "agentSteps" : {"message": string; "level": "INFO" | "DEBUG"}[]
} 
```
