...
| `documents` | `OmnilexFile[]`           | No       | The files attached to the question. See [OmnilexFile Types](/omnilex_file_types) for details. |
...
// OmnilexFile types are defined in the OmnilexFile Types page
// See: /omnilex_file_types

// ConsiderationType and ConsiderationDetails types are defined in the ConsiderationDetails Types page
// See: /consideration_details_types
...
For a complete reference of all `ConsiderationType` enum values and `ConsiderationDetails` type definitions, see the [ConsiderationDetails Types](/consideration_details_types) documentation page.
