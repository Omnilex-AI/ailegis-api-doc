...
All calls to the Omnilex API require a **Bearer Authentication**.
...
If you do not have yet a secret key, or your key is expired, reach out to us at support@omnilex.ai . 
